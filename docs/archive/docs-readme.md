# DriftSentry Documentation (Archived)

> [!NOTE]
> **Archive Notice**: This documentation index has been consolidated into the root [README.md](../../README.md). Preserved for historical reference.
...
| [🖥️ CLI Reference](../api.md) | Complete reference for all CLI commands (`scan`, `report`, `remediate`) and options. | Everyone |
...
| [🧩 Custom Resources](../custom-resources.md) | How to add any AWS service using zero-code Declarative YAML or Python plugins. | Platform Engineers & Contributors |
...
| [🔄 CI/CD & Deployment](../deployment.md) | Integrating DriftSentry into GitHub Actions and GitLab CI for scheduled drift scans. | DevOps Engineers |
